...
NOTE: This is a vendored copy of evanz/url-parser, with this pull-request merged:
      https://github.com/evancz/url-parser/pull/22
      adding functions: requiredStringParam, requiredIntParam, customRequiredParam
